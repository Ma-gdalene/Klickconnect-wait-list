...
const OUTSTANDING_FOUNDERS = [
  {
    ...
    portfolio: [
      ...
      "/src/assets/images/grad_photoshoot_1780930412385.png",
...
const VANGUARD_SCENES = [
  {
    title: "Graduation Milestone Portraiture",
    caption: "A milestone university graduation session captured by our premier portrait photographers. A beautiful young Black lady celebrating academic excellence.",
    badge: "GRADUATION ACCOLADES",
    imageUrl: "/src/assets/images/grad_photoshoot_1780930412385.png",
    details: "Accra, High-End Campus Set • Photographed by @xelanvisuels"
  },
  {
    ...
    <div className="min-h-screen bg-black text-neutral-100 font-sans-premium selection:bg-amber-400 selection:text-black">
      ...
      <section className="relative pt-6 pb-20 overflow-hidden border-b border-neutral-900" id="hero-intro">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="relative rounded-3xl overflow-hidden mb-16 border border-neutral-800/80 w-full min-h-[420px] sm:min-h-[500px] md:min-h-[580px] lg:min-h-[620px] flex items-center justify-center py-12 sm:py-16 md:py-24 px-4 sm:px-8 md:px-16 select-none shadow-[0_0_50px_rgba(217,180,85,0.06)] group">
            ...
            <img 
              ...
              className="absolute inset-0 w-full h-full object-cover object-center brightness-[0.35] group-hover:scale-102 transition-transform duration-1000 pointer-events-none"
            />
            ...
            <div className="relative z-10 text-center max-w-2xl mx-auto space-y-5 sm:space-y-6 flex flex-col items-center">
              
              {/* Handcrafted animated Sparkle container */}
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4.5 py-1 sm:py-1.5 rounded-full bg-black/80 border border-[#D9B455]/30 shadow-[0_0_15px_rgba(217,180,85,0.1)]">
                <span className="h-1.5 w-1.5 rounded-full bg-[#D9B455] animate-ping" />
                <span className="text-[8px] sm:text-[10px] font-mono-tech uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[#D9B455] font-bold">SOMETHING EXTRAORDINARY IS COMING</span>
              </div>

              {/* Majestic gold metallic logo */}
              <div className="h-20 w-20 sm:h-28 sm:w-28 md:h-36 md:w-36 filter drop-shadow-[0_0_12px_rgba(217,180,85,0.3)] hover:scale-105 transition-transform duration-500 cursor-pointer">
                <Logo className="w-full h-full" />
              </div>

              {/* Brand pair text */}
              <div className="space-y-1 sm:space-y-2">
                <h2 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-normal text-white">
                  Klick<span className="text-[#D9B455] font-light font-sans-premium">Connect</span>
                </h2>
                <p className="text-[8px] sm:text-[10px] md:text-xs tracking-[0.25em] sm:tracking-[0.35em] text-[#D9B455]/85 uppercase font-bold">
                  C O N N E C T . &nbsp; B O O K . &nbsp; C R E A T E .
                </p>
              </div>

              {/* Sparkle divider and tagline */}
              <div className="flex flex-col items-center space-y-1.5 sm:space-y-2 pt-1 sm:pt-2">
                ...
                <p className="text-neutral-300 font-serif-display text-xs sm:text-sm md:text-base font-light italic max-w-md px-2">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4 text-center sm:text-left">
                  <div className="space-y-1.5 flex flex-col items-center sm:items-start">
                    ...
                    <h3 className="text-[#D9B455] text-3xl sm:text-4xl md:text-5xl font-black tracking-tight font-serif-display uppercase leading-none">
                      LAUNCHING <br />
                      <span className="text-white">SOON!</span>
                    </h3>
                  </div>
                  <div className="h-14 w-14 border border-[#D9B455]/40 rounded-full p-1.5 bg-black shrink-0">
                    <Logo className="w-full h-full" />
                  </div>
                </div>
